...
const PrizePool = () => {
  ...
  const totalAssets = totalAssetsData ? `${formatEther(totalAssetsData as bigint)} WETH` : '-';
  const totalPrincipal = totalPrincipalData ? `${formatEther(totalPrincipalData as bigint)} WETH` : '-';
